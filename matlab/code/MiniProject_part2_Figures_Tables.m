...
ylim([-0.003 0.004])
xlim([-0.5 0.5])
Graph_Title=['Whisking onset averages - all cells'];
title(Graph_Title) % write the tittle of the graph
xlabel('Time (s)') % label the x axis
ylabel('Vm (V)') % label the y axis
...
Expression=[PathSaveFigures filesep '10_WhiskOnset_GRD_AVG_Vm_Overlay'];
...
Expression=[PathSaveFigures filesep '11_WhiskOnset_Vm_Amplitude'];
...
xlim([0.5 4.5])
ylim([-0.005 0.015])
Graph_Title=['Change Vm at whisking onset'];
title(Graph_Title) % write the tittle of the graph
...
Expression=[PathSaveFigures filesep '12_WhiskOnset_Vm_Amplitude_Compare'];
...
Expression=[PathSaveFigures filesep '13_WhiskOnset_GRD_AVG_AP_Overlay'];
...
Expression=[PathSaveFigures filesep '14_WhiskOnset_DeltaFR'];
...
xlim([0.5 4.5])
ylim([-10 55])
Graph_Title=['Change FR at whisking onset'];
title(Graph_Title) % write the tittle of the graph
xlabel('Cell Class') % label the x axis
...
ylabel('FR (Hz)') % label the y axis
expression=['Rho = ' num2str(RHO(1,2)) ', p =' num2str(PVAL(1,2)) ];
text(ax, 50,18,expression, 'FontSize',8)
...
ylabel('FR (Hz)') % label the y axis
expression=['Rho = ' num2str(RHO(1,2)) ', p =' num2str(PVAL(1,2)) ];
text(ax, 50,60,expression, 'FontSize',8)
...
expression=['Rho = ' num2str(RHO(1,2)) ', p =' num2str(PVAL(1,2)) ];
text(ax, 50,30,expression, 'FontSize',8)
...
Expression=[PathSaveFigures filesep '15_Whisking_Onset_DeltaFRvsVm'];
